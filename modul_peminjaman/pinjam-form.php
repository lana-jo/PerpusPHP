  ...
  <div class="container">
    ...
    <main class="content">
      <header class="main-header">
        <h1 class="header-title">Transaksi Peminjaman</h1>
      </header>
      
      <div class="content-header">
        <h2 class="content-title">Tambah Peminjaman Baru</h2>
        <p class="content-subtitle">Isi data peminjaman buku di bawah ini</p>
      </div>
        ...
        <form action="proses-tambah-pinjam.php" method="post">
          <div class="form-group">
            ...
            <select id="buku" name="buku" class="form-select" required>
              ...
              <option value="<?php echo $buku['buku_id'] ?>"><?php echo htmlspecialchars($buku['buku_judul']) ?></option>
              <?php endforeach ?>
            </select>
          </div>
          ...
          <div class="form-group">
            ...
            <select id="anggota" name="anggota" class="form-select" required>
              ...
              <option value="<?php echo $anggota['anggota_id'] ?>"><?php echo htmlspecialchars($anggota['anggota_nama']) ?></option>
              <?php endforeach ?>
            </select>
          </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="date" id="tgl_pinjam" name="tgl_pinjam" class="form-input" required>
            </div>
            
            <div class="form-group">
              <label class="form-label" for="tgl_jatuh_tempo">Tanggal Jatuh Tempo</label>
              <input type="date" id="tgl_jatuh_tempo" name="tgl_jatuh_tempo" class="form-input" required>
            </div>
          </div>
